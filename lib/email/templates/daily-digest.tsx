      ...
      >
        ...
        >
          ...
          <div style={{ padding: '24px' }}>
            ...
            >
              We found {totalCount} new vehicle{totalCount !== 1 ? 's' : ''}{' '}
              matching your criteria today. Here{' '}
              {totalCount === 1 ? 'is' : 'are'} the top{' '}
              {Math.min(vehicles.length, 5)} sorted by priority score:
            </p>
